...
void unmap(Display*, const Window, const Window);
void key(Display*, const Window, const int, const int);
static void unfocus(Display*, const Window, const Window);
static void focus(Display*, const Window, const Window);
static client_t* find_client(const client_t*);
