...
void setprop_state(const Window);
void setprop_active(const Window);
void delprop_active(const Window);
void setprop_nwks(const int);
void setprop_wks(const int);
bool getprop_name(unsigned char**, const Window, const long, const long);
bool getprop_utfname(unsigned char**, const Window, const long, const long);
