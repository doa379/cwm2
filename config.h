...
input_t const KBD[] = {
  ...
  { ControlMask | Mod4Mask, XK_F1, .call = calls_mon1 },
  { ControlMask | Mod4Mask, XK_F2, .call = calls_mon2 },
  { ControlMask | Mod4Mask, XK_F3, .call = calls_mon3 },
  { ControlMask | Mod4Mask, XK_F4, .call = calls_mon4 },
  { ControlMask | Mod4Mask, XK_F5, .call = calls_mon5 },
  { ControlMask | Mod4Mask, XK_F6, .call = calls_mon6 },
  { ControlMask | Mod4Mask, XK_F7, .call = calls_mon7 },
  { ControlMask | Mod4Mask, XK_F8, .call = calls_mon8 },
  { ControlMask | Mod4Mask, XK_F9, .call = calls_mon9 },
  { ControlMask | Mod4Mask, XK_F10, .call = calls_mon10 },
  { ControlMask | Mod4Mask, XK_F11, .call = calls_mon11 },
  { ControlMask | Mod4Mask, XK_F12, .call = calls_mon12 },
